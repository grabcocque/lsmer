...
#[tokio::test]
async fn test_durability_error_from_wal_error() {
...
#[tokio::test]
async fn test_durability_error_from_io_error() {
    let test_future = async {
...
#[tokio::test]
async fn test_durability_error_from_memtable_error() {
    let test_future = async {
...
#[tokio::test]
async fn test_durability_error_variants() {
    let test_future = async {
